<%@ Control Language="C#" AutoEventWireup="true" CodeFile="anakategoriurun.ascx.cs" Inherits="moduller_anakategoriurun" %>
...
<table cellpadding="0" cellspacing="0" style="width: 100%;">
        ...
        <td class="auto-style2" style="background-image: url('/temalar/resim/dmt_bg.gif'); background-repeat: repeat-x; vertical-align: middle; text-align: center"> 
            <asp:Label ID="lblAKAD" runat="server"></asp:Label>
&nbsp;Ana Kategorisine Ait Ürünlerimiz</td>
        <td class="auto-style1">
...
<cc1:CollectionPager ID="CollectionPager1" runat="server" PageSize="6">
</cc1:CollectionPager>
