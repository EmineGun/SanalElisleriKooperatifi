<%@ Control Language="C#" AutoEventWireup="true" CodeFile="sonurunler.ascx.cs" Inherits="bloklar_sonurunler" %>
<style type="text/css">
...
<table cellpadding="0" cellspacing="0" style="width: 100%;">
        ...
        <td class="auto-style2" style="background-image: url('temalar/resim/dmt_bg.gif'); background-repeat: repeat-x; vertical-align: middle; text-align: center">YENİ EKLENEN ÜRÜNLERİMİZ</td>
        <td class="auto-style1">
